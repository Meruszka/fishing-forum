...
const SideBar: React.FC<SideBarProps> = (props: SideBarProps): ReactElement => {
  ...
  return (
    <>
      ...
      <div className="sidebar-scroll max-h-full overflow-y-auto scrollbar-thin scrollbar-thumb-gray-800 scrollbar-track-gray-300 scrollbar scrollbar-thumb-gray-900 scrollbar-track-gray-100 snap-y">
